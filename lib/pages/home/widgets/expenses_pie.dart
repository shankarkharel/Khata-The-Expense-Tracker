      ...
      for (var i = 0; i < map.length; i++) {
        ...
        slices.add(
          PieChartSectionData(
            ...
            value: value.amount,
            color:Color(value.category.color.withOpacity(MConst.opacity).hashCode),
            showTitle: false,
            title: value.category.text.toString(),
          ),
        );
      }
    }
                  ...
                  ? RichText(
                      ...
                      text: TextSpan(
                        children: [
                          ...
                          TextSpan(
                            text: '\n रु${totalSpend.toStringAsFixed(2)}',
                  ...
                  : RichText(
                      ...
                      text: TextSpan(
                        children: [
                          ...
                          TextSpan(
                            text:
                                '\nरु${slices[touchedIndex].value.toStringAsFixed(2)}',
                            style: Theme.of(context)
                                .textTheme
                                .headline5!
                                .copyWith(fontWeight: FontWeight.bold),
